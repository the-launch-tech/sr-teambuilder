...
class DatabaseSeeder extends Seeder {
  public function run() {
    /** Could create Artisan Command, but this is fine for now. */
    DB::insert(
      "INSERT INTO `users` (`id`, `user_type`, `first_name`, `last_name`, `ranking`, `can_play_goalie`)
      VALUES
      	(1,'player','Scott','Marr',5,0),
      	...
      	(60,'coach','Dan','Ambrose',0,0),
      	(61,'player','Matthew','Klank',4,0),
